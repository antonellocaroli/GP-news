...
###############################################
echo -e " ────────────────────────────────────────────"
echo -e "$BGreen 29.03.20$Color_Off $BBlack Rpi3/Rpi4 Update versione 2.11 to 2.12$Color_Off"
echo "Depending on the speed of the CPU and/or optical media it can take a long time.."
...
###############################################
echo -e " ────────────────────────────────────────────"
echo -e "$BGreen 19.04.20$Color_Off $BBlack Rpi3/Rpi4 Update versione 2.12 to 2.13$Color_Off"
echo "Depending on the speed of the CPU and/or optical media it can take a long time.."
echo -e "Changelog: http://www.gentooplayer.com/news"
echo
echo -e "to update:
